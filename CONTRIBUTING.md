...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docmark-extension-hashbang
   cd docmark-extension-hashbang
   ```
...
```sh
https://github.com/flex-development/docmark-extension-hashbang/compare/main...$branch
```
